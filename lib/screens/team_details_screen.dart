...
import 'package:consumo_api_flutter/viewmodels/team_details_viewmodel.dart';
...
class _TeamDetailsScreenState extends State<TeamDetailsScreen> {
  final TeamDetailsViewmodel teamDetailsViewmodel = TeamDetailsViewmodel();
  @override
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: FutureBuilder<List<PlayerModel>>(
          future: teamDetailsViewmodel.getAllPlayersForOneTeam(widget.teamModel.id),
